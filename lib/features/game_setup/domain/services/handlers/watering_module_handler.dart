...
/// TODO: Implement preparation steps for watering tiles.
/// TODO: Handle initial tile change when watering is active.
class WateringModuleHandler implements ModulePreparationHandler {
  ...
  List<TileModel> adjustTiles(List<TileModel> tiles, int playerCount) {
    // TODO: Implement watering tile substitutions.
    return tiles;
  }
  ...
  List<PreparationEntity> modifyPreparationSteps(
    ...
    // TODO: Implement watering preparation steps.
    return currentSteps;
  }
}
