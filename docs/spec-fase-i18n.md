...
- **Castellà**: la **traducció oficial de Devir** (Marc Figueras i Marià Pitarque, Devir Iberia). Termes clau que difereixen d'una traducció literal de l'anglès: *recolectores* (workers), *aguador* (water carrier), *remansos* del riu (water fields), *aldea* (village board), *losetas de selva* (jungle tiles), *pila de la selva* i *selva explorada* (draw pile / display), *cenote* (water tile), *mercado de precio de venta «2»*, *irrigación* (watering), *chocolatera* (chocolate kitchen), *tabletas de chocolate*, *bohíos* (huts). Expansions: **Xocolatl** (no "Chocolatl") amb mòduls *Mapas / Irrigación / Chocolate / Bohíos*; **Diamante** amb *Las minas de gemas / El árbol de la vida / El favor del **ahau** / Los nuevos recolectores*. Fonts: PDF oficial de Xocolatl (quejuegosdemesa.com), fitxes de producte Devir i ressenya Misut Meeple. **Diamante confirmat sense PDF** (no n'hi ha cap de públic, verificat 2026-07-20): *vagoneta*, *gemas* i *máscaras* per la ressenya de Misut Meeple de l'edició es/pt de Devir, i els noms dels mòduls (*Las minas de gemas / El árbol de la vida / El favor del ahau / Los nuevos recolectores*) pel text de producte oficial de Devir reproduït a les botigues.
- **Català**: no hi ha edició oficial. Terminologia pròpia **derivada del castellà oficial de Devir** on dona sabor i és bon català — *recol·lectors*, *aiguader*, *remans*, *selva* (i *selva explorada*, *pila de la selva*), *cenot*, *irrigació*, *xocolatera*, *tauletes de xocolata* (mai "rajoles de xocolata": col·lisió amb rajola=tile), *ahau*, *mercat de preu de venda «2»* — i mantenint el terme català propi on és millor que el castellà: **poblat** (no "aldea"), **cabana** (no "bohío"), **rajoles** (no "losetas"). ⚠ El DESIGN.md encara usa els sinònims antics (treballadors, portador d'aigua, jungla, El Reg, Emperador): pendent d'alinear-lo en una passada editorial.
